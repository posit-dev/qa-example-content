"""Plot the galactocentric frame.

Source: https://astro-docs.readthedocs.io/en/latest/generated/examples/coordinates/plot_galactocentric-frame.html
...
pm_gal_sgrA = [-6.379, -0.202] * u.mas/u.yr
...
phi_grid = np.linspace(90, 270, 512) * u.degree
