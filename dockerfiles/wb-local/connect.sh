...
if [ "$CI_MODE" = true ]; then
  ...
  docker exec -it \
    ...
    -e DATABRICKS_SERVICE_ACCOUNT_EMAIL_="${DATABRICKS_SERVICE_ACCOUNT_EMAIL:-}" \
    -e DATABRICKS_SERVICE_ACCOUNT_PASSWORD_="${DATABRICKS_SERVICE_ACCOUNT_PASSWORD:-}" \
    -e DATABRICKS_SERVICE_ACCOUNT_OTP_SECRET_="${DATABRICKS_SERVICE_ACCOUNT_OTP_SECRET:-}" \
